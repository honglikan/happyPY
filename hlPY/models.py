...
class course_python_basic(models.Model):
    ...
    basic_chapter_id = models.IntegerField(blank=False)#课程章节号
...
class basic_learn_progress(models.Model):
    ...
    basic_id = models.IntegerField(blank=False)#基础课程ID
    basic_chapter_id = models.IntegerField(blank=False)#基础课程章节号
    basic_contant_id = models.ForeignKey('course_python_basic',to_field='basic_contant_id',on_delete='CASCADE')  # 课程内容ID
    learn_status = models.CharField(max_length=2)#学习状态
...
#     basic_id = models.IntegerField(blank=False)
#     basic_chapter_id = models.IntegerField(blank=False)
...
class course_python_practice(models.Model):
    practice_id = models.IntegerField(blank=False)#实战课程编号
...
class practice_learn_progress(models.Model):
    ...
    practice_chapter_id = models.IntegerField(blank=False)#实战课程章节ID
    practice_info_id = models.ForeignKey('course_python_practice',to_field='practice_info_id',on_delete='CASCADE')
